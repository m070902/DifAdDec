...
IMPORTANT:
The current library continuously injects:
    concentration[source] += emission_rate * dt
at every time step. Therefore emission_rate is interpreted here as a
continuous source rate.
